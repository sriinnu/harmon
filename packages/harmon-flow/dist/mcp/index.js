...
export class HarmonFlowMCPServer {
     ...
     */
    async handleFindSimilarSessions(args) {
        const mood = args.mood;
        const energy = args.energy;
    ...
    async handleGetPatterns(args) {
        ...
        this.ensureGraphBuilt();
        const detector = new PatternDetector({ nodes: new Map(), edges: new Map(), embeddings: new Map() }, this.entries);
        const patterns = detector.getAllPatterns();
        let result = {};
     ...
     */
    async handleGetEntries(args) {
        const limit = args.limit || 10;
        const moodFilter = args.mood;
        this.refreshEntries();
     ...
     */
    async handleAnalyzeMoodTrends(args) {
